  ...
  try {
    ...
    const newCampaign: Campaign = {
      ...
      settings: {
        ...
        plainTextMode: settings?.plainTextMode ?? true,
        ...
        sendWindowStart: settings?.sendWindowStart ?? '00:00',
        sendWindowEnd: settings?.sendWindowEnd ?? '23:59',
        timezone: settings?.timezone ?? 'Asia/Kolkata',
        sendDays: settings?.sendDays ?? [0, 1, 2, 3, 4, 5, 6],
